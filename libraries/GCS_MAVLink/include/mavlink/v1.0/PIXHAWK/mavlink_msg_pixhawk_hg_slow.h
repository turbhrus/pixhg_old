...
#define MAVLINK_MSG_ID_PIXHAWK_HG_SLOW 202
...
#define MAVLINK_MSG_ID_202_CRC 187
						       ...
						       uint64_t gps_time_us, uint16_t eph, int32_t gps_alt, uint8_t gps_fix_type, uint8_t satellites_visible, float temperature, uint8_t humidity, float wind_n, float wind_e, float wind_d)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_PIXHAWK_HG_SLOW_LEN, MAVLINK_MSG_ID_PIXHAWK_HG_SLOW_CRC);
#else
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_PIXHAWK_HG_SLOW_LEN);
#endif
}
						           ...
						           uint64_t gps_time_us,uint16_t eph,int32_t gps_alt,uint8_t gps_fix_type,uint8_t satellites_visible,float temperature,uint8_t humidity,float wind_n,float wind_e,float wind_d)
{
	...
	msg->msgid = MAVLINK_MSG_ID_PIXHAWK_HG_SLOW;
#if MAVLINK_CRC_EXTRA
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_PIXHAWK_HG_SLOW_LEN, MAVLINK_MSG_ID_PIXHAWK_HG_SLOW_CRC);
#else
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_PIXHAWK_HG_SLOW_LEN);
#endif
}
...
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_PIXHAWK_HG_SLOW, buf, MAVLINK_MSG_ID_PIXHAWK_HG_SLOW_LEN, MAVLINK_MSG_ID_PIXHAWK_HG_SLOW_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_PIXHAWK_HG_SLOW, buf, MAVLINK_MSG_ID_PIXHAWK_HG_SLOW_LEN);
#endif
#else
	mavlink_pixhawk_hg_slow_t packet;
	packet.gps_time_us = gps_time_us;
...
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_PIXHAWK_HG_SLOW, (const char *)&packet, MAVLINK_MSG_ID_PIXHAWK_HG_SLOW_LEN, MAVLINK_MSG_ID_PIXHAWK_HG_SLOW_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_PIXHAWK_HG_SLOW, (const char *)&packet, MAVLINK_MSG_ID_PIXHAWK_HG_SLOW_LEN);
#endif
#endif
}
...
#else
	memcpy(pixhawk_hg_slow, _MAV_PAYLOAD(msg), MAVLINK_MSG_ID_PIXHAWK_HG_SLOW_LEN);
#endif
}
