...
#define MAVLINK_MSG_ID_XCSOAR_CALCULATED 233
...
#define MAVLINK_MSG_ID_233_LEN 10

#define MAVLINK_MSG_ID_XCSOAR_CALCULATED_CRC 31
#define MAVLINK_MSG_ID_233_CRC 31
						       ...
						       float speed_to_fly, uint8_t flying, uint8_t circling, uint16_t current_turnpoint, uint8_t airspace_warning_idx, uint8_t terrain_warning)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_XCSOAR_CALCULATED_LEN, MAVLINK_MSG_ID_XCSOAR_CALCULATED_CRC);
#else
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_XCSOAR_CALCULATED_LEN);
#endif
}
						           ...
						           float speed_to_fly,uint8_t flying,uint8_t circling,uint16_t current_turnpoint,uint8_t airspace_warning_idx,uint8_t terrain_warning)
{
	...
	msg->msgid = MAVLINK_MSG_ID_XCSOAR_CALCULATED;
#if MAVLINK_CRC_EXTRA
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_XCSOAR_CALCULATED_LEN, MAVLINK_MSG_ID_XCSOAR_CALCULATED_CRC);
#else
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_XCSOAR_CALCULATED_LEN);
#endif
}
...
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_XCSOAR_CALCULATED, buf, MAVLINK_MSG_ID_XCSOAR_CALCULATED_LEN, MAVLINK_MSG_ID_XCSOAR_CALCULATED_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_XCSOAR_CALCULATED, buf, MAVLINK_MSG_ID_XCSOAR_CALCULATED_LEN);
#endif
#else
	mavlink_xcsoar_calculated_t packet;
	packet.speed_to_fly = speed_to_fly;
...
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_XCSOAR_CALCULATED, (const char *)&packet, MAVLINK_MSG_ID_XCSOAR_CALCULATED_LEN, MAVLINK_MSG_ID_XCSOAR_CALCULATED_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_XCSOAR_CALCULATED, (const char *)&packet, MAVLINK_MSG_ID_XCSOAR_CALCULATED_LEN);
#endif
#endif
}
...
#else
	memcpy(xcsoar_calculated, _MAV_PAYLOAD(msg), MAVLINK_MSG_ID_XCSOAR_CALCULATED_LEN);
#endif
}
