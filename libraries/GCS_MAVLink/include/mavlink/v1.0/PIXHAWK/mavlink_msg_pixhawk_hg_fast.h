...
#define MAVLINK_MSG_ID_PIXHAWK_HG_FAST 200
...
#define MAVLINK_MSG_ID_200_CRC 186
						       ...
						       uint32_t gps_time, float xacc, float yacc, float zacc, float roll, float pitch, uint16_t hdg)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_PIXHAWK_HG_FAST_LEN, MAVLINK_MSG_ID_PIXHAWK_HG_FAST_CRC);
#else
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_PIXHAWK_HG_FAST_LEN);
#endif
}
						           ...
						           uint32_t gps_time,float xacc,float yacc,float zacc,float roll,float pitch,uint16_t hdg)
{
	...
	msg->msgid = MAVLINK_MSG_ID_PIXHAWK_HG_FAST;
#if MAVLINK_CRC_EXTRA
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_PIXHAWK_HG_FAST_LEN, MAVLINK_MSG_ID_PIXHAWK_HG_FAST_CRC);
#else
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_PIXHAWK_HG_FAST_LEN);
#endif
}
...
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_PIXHAWK_HG_FAST, buf, MAVLINK_MSG_ID_PIXHAWK_HG_FAST_LEN, MAVLINK_MSG_ID_PIXHAWK_HG_FAST_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_PIXHAWK_HG_FAST, buf, MAVLINK_MSG_ID_PIXHAWK_HG_FAST_LEN);
#endif
#else
	mavlink_pixhawk_hg_fast_t packet;
	packet.gps_time = gps_time;
...
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_PIXHAWK_HG_FAST, (const char *)&packet, MAVLINK_MSG_ID_PIXHAWK_HG_FAST_LEN, MAVLINK_MSG_ID_PIXHAWK_HG_FAST_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_PIXHAWK_HG_FAST, (const char *)&packet, MAVLINK_MSG_ID_PIXHAWK_HG_FAST_LEN);
#endif
#endif
}
...
#else
	memcpy(pixhawk_hg_fast, _MAV_PAYLOAD(msg), MAVLINK_MSG_ID_PIXHAWK_HG_FAST_LEN);
#endif
}
