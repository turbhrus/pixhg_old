...
#define MAVLINK_MSG_ID_PIXHAWK_HG_MED 231
...
#define MAVLINK_MSG_ID_231_LEN 28

#define MAVLINK_MSG_ID_PIXHAWK_HG_MED_CRC 44
#define MAVLINK_MSG_ID_231_CRC 44
						       ...
						       int32_t lat, int32_t lon, int32_t alt, int16_t vx, int16_t vy, int16_t vz, int16_t energy_vario, float indicated_airspeed, float true_airspeed)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_PIXHAWK_HG_MED_LEN, MAVLINK_MSG_ID_PIXHAWK_HG_MED_CRC);
#else
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_PIXHAWK_HG_MED_LEN);
#endif
}
						           ...
						           int32_t lat,int32_t lon,int32_t alt,int16_t vx,int16_t vy,int16_t vz,int16_t energy_vario,float indicated_airspeed,float true_airspeed)
{
	...
	msg->msgid = MAVLINK_MSG_ID_PIXHAWK_HG_MED;
#if MAVLINK_CRC_EXTRA
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_PIXHAWK_HG_MED_LEN, MAVLINK_MSG_ID_PIXHAWK_HG_MED_CRC);
#else
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_PIXHAWK_HG_MED_LEN);
#endif
}
...
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_PIXHAWK_HG_MED, buf, MAVLINK_MSG_ID_PIXHAWK_HG_MED_LEN, MAVLINK_MSG_ID_PIXHAWK_HG_MED_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_PIXHAWK_HG_MED, buf, MAVLINK_MSG_ID_PIXHAWK_HG_MED_LEN);
#endif
#else
	mavlink_pixhawk_hg_med_t packet;
	packet.lat = lat;
...
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_PIXHAWK_HG_MED, (const char *)&packet, MAVLINK_MSG_ID_PIXHAWK_HG_MED_LEN, MAVLINK_MSG_ID_PIXHAWK_HG_MED_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_PIXHAWK_HG_MED, (const char *)&packet, MAVLINK_MSG_ID_PIXHAWK_HG_MED_LEN);
#endif
#endif
}
...
#else
	memcpy(pixhawk_hg_med, _MAV_PAYLOAD(msg), MAVLINK_MSG_ID_PIXHAWK_HG_MED_LEN);
#endif
}
